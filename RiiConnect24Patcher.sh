...
function number_2_3 {
    ...
    if [ $percent == 29 ]; then wine Sharpii.exe NUSD -ios 31 -v latest -all; fi
    if [ $percent == 29 ]; then mv "IOS31-64-3608/000000010000001fv3608.wad" "IOSPatcher/IOS31-old.wad"; fi

    if [ $percent == 30 ]; then wine Sharpii.exe NUSD -ios 80 -v latest -all; fi
    if [ $percent == 30 ]; then mv "IOS80-64-6944/0000000100000050v6944.wad" "IOSPatcher/IOS80-old.wad"; fi

    if [ $percent == 31 ]; then wine Sharpii.exe WAD -u "IOSPatcher/IOS31-old.wad" "IOSPatcher/IOS31/"; fi

    if [ $percent == 32 ]; then wine Sharpii.exe WAD -u "IOSPatcher/IOS80-old.wad" "IOSPatcher/IOS80/"; fi
    ...
    if [ $percent == 44 ]; then wine Sharpii.exe WAD -p "IOSPatcher/IOS31/" "IOSPatcher/WAD/IOS31.wad" -fs; fi

    if [ $percent == 45 ]; then wine Sharpii.exe WAD -p "IOSPatcher/IOS80/" "IOSPatcher/WAD/IOS80.wad" -fs; fi
    ...
    if [ $percent == 52 ]; then wine Sharpii.exe IOS "IOSPatcher/WAD/IOS31.wad" -fs -es -np -vp; fi

    if [ $percent == 53 ]; then wine Sharpii.exe IOS "IOSPatcher/WAD/IOS80.wad" -fs -es -np -vp; fi
    ...
    if [[ $percent == 80 && $evcregion == 2 ]]; then wine Sharpii.exe WAD -p "0001000148414A45/512/" "WAD/Everybody Votes Channel RiiConnect24 USA.wad" -f; fi
    if [[ $percent == 80 && $evcregion == 1 ]]; then wine Sharpii.exe WAD -p "0001000148414A50/512/" "WAD/Everybody Votes Channel RiiConnect24 Europe.wad" -f; fi
