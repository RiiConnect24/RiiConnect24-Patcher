...
if %funfact_number%==18 set funfact=In the Wii System menu version 2.0 is a unused dvd disk graphic. Nintendo wanted to support DVDs, but they had licenseing issues so they canceled that feature.
